...
date:   2022-04-04 21:40:48 +0000
categories: architecture lean design patterns ddd coupling cohesion
---
...
1. Coupling gets broken into 3 aspects. 
  i. The type of coupling (the name) which I will again come back to immediatley below.
  ii. the distance between the 2 things that are coupled
1. The breakdown and naming of the types along with the sequencing of them enables moves and direction when refactoring. Eg performing an extract method refactor to convert connascence of algorithm into connascence of name. As these are names for types of cou
